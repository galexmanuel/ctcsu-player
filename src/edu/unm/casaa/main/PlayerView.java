...
public class PlayerView extends JFrame {
    ...
    public JSlider getSliderSeek() {
        if (sliderSeek == null) {
            sliderSeek = new JSlider(SwingConstants.HORIZONTAL, SEEK_MIN_VAL, SEEK_MAX_VAL, SEEK_INIT_VAL);
    ...
    private JPanel getBottomLayoutPanel() {
        if (bottomLayoutPanel == null) {
            ...
            bottomLayoutPanel.setMaximumSize(new Dimension(BOTTOM_PANEL_WIDTH, BOTTOM_PANEL_HEIGHT));
            bottomLayoutPanel.setMinimumSize(new Dimension(BOTTOM_PANEL_WIDTH, BOTTOM_PANEL_HEIGHT));
